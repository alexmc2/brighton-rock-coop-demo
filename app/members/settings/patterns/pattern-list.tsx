  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-lg font-semibold">Active Patterns</h2>
          <p className="text-sm text-muted-foreground">
            These patterns are used to automatically categorize your
            transactions.
          </p>
        </div>
        ...
        <Dialog>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Add a new pattern to automatically categorize transactions.
              </DialogDescription>
            </DialogHeader>
            <CreatePatternForm onSuccess={handlePatternCreated} />
          </DialogContent>
        </Dialog>
      </div>
            ...
            {patterns.length === 0 && (
              <TableRow>
                <TableCell colSpan={6} className="text-center py-4">
                  No patterns found. Add one to start automatically categorizing
                  transactions.
                </TableCell>
              </TableRow>
            )}
