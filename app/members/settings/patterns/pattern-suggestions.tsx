...
export function PatternSuggestions({ suggestions }: PatternSuggestionsProps) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-lg font-semibold">Pattern Suggestions</h2>
          ...
          <TableBody>
            {suggestions.map((suggestion, index) => (
              <TableRow key={index}>
                ...
                <TableCell>
                  <Badge
                    variant={suggestion.is_expense ? 'destructive' : 'default'}
                  >
            ...
            {suggestions.length === 0 && (
              <TableRow>
                <TableCell colSpan={5} className="text-center py-4">
                  No suggestions available. Add more transactions to get pattern
                  suggestions.
                </TableCell>
              </TableRow>
            )}
