// app/members/(default)/treasury/expenses/expense-claims.tsx
        ...
        <CardContent>
          <Card className="bg-slate-50 dark:bg-slate-900  border-none mb-6">
            ...
            <CardContent className="text-sm text-slate-600 dark:text-slate-300">
              Submit expense claims with receipts for co-op related purchases
              using the correct category. Claims will be processed by the
              treasury team within 7 days.
            </CardContent>
          </Card>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-sm min-w-[200px]">
                      Description
                    </TableHead>
                    <TableHead className="text-sm w-[100px]">Amount</TableHead>
                    <TableHead className="text-sm w-[100px]">
                      Submitted By
                    </TableHead>
