...
import UserAvatar from '@/public/members/images/user-avatar-32.png'
...
import UserImage07 from '@/public/members/images/user-32-07.jpg'
import SponsorImg from '@/public/members/images/company-icon-06.svg'
        ...
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            ...
            <h2 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">
              <Link href="/members/community/forum/post">Share Your Startup - December 2024 - Upvote This For Maximum Visibility!</Link>
            </h2>
            {/* Footer */}
      ...
      <article className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-5">
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            {/* Title */}
            <h2 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">
              <Link href="/members/community/forum/post">Failed for the past 12 years as a tech entrepreneur. My key takeaways.</Link>
            </h2>
            {/* Footer */}
            <footer className="flex flex-wrap text-sm">
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-gray-400 dark:after:text-gray-600 after:px-2">
      ...
      <article className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-5">
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            {/* Title */}
            <h2 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">
              <Link href="/members/community/forum/post">Besides Product Hunt, where else should I promote my new project? 🤔</Link>
            </h2>
            {/* Footer */}
            <footer className="flex flex-wrap text-sm">
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-gray-400 dark:after:text-gray-600 after:px-2">
      ...
      <article className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-5">
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            {/* Title */}
            <h2 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">
              <Link href="/members/community/forum/post">
      ...
      <article className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-5">
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            {/* Title */}
            <h2 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">
              <Link href="/members/community/forum/post">Which are the main channels you use to drive traffic to your website? 📈</Link>
            </h2>
            {/* Footer */}
            <footer className="flex flex-wrap text-sm">
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-gray-400 dark:after:text-gray-600 after:px-2">
      ...
      <article className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-5">
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            {/* Title */}
            <h2 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">
              <Link href="/members/community/forum/post">What's the best way to get started building web 3 social products?</Link>
            </h2>
            {/* Footer */}
            <footer className="flex flex-wrap text-sm">
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-gray-400 dark:after:text-gray-600 after:px-2">
      ...
      <article className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-5">
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            {/* Title */}
            <h2 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">
              <Link href="/members/community/forum/post">How important is customer feedback for the improvement of a product?</Link>
            </h2>
            {/* Footer */}
            <footer className="flex flex-wrap text-sm">
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-gray-400 dark:after:text-gray-600 after:px-2">
