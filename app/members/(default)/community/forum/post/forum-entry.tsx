...
import UserAvatar from '@/public/members/images/user-40-02.jpg'
import UserImage01 from '@/public/members/images/user-28-01.jpg'
import UserImage02 from '@/public/members/images/user-28-02.jpg'
import UserImage05 from '@/public/members/images/user-28-05.jpg'
import UserImage09 from '@/public/members/images/user-28-09.jpg'
import UserImage10 from '@/public/members/images/user-28-10.jpg'
      ...
      <div className="mb-2">
        <ul className="inline-flex flex-wrap text-sm font-medium">
          <li className="flex items-center">
            <Link className="text-gray-500 dark:text-gray-400 hover:text-violet-500 dark:hover:text-violet-500" href="/members/community/forum">
              Home
            </Link>
        ...
        <ul className="space-y-5">
          ...
          <li className="relative pl-9 space-y-5">
            ...
            <div className="flex items-start">
              ...
              <div className="absolute top-0 left-0">
                <button className="text-xs font-semibold text-left w-6 rounded-sm flex flex-col justify-center items-center text-gray-600 dark:text-gray-300 hover:text-violet-500 dark:hover:text-violet-500">
                  <svg className="inline-flex fill-gray-400 dark:fill-gray-500 mt-1.5 mb-1.5" width="12" height="6" xmlns="http://www.w3.org/2000/svg">
                    <path d="m0 6 6-6 6 6z" />
                  </svg>
                  <div>44</div>
          ...
          <li className="relative pl-9 space-y-5">
            ...
            <div className="flex items-start">
              {/* Comment upvote */}
              <div className="absolute top-0 left-0">
                <button className="text-xs font-semibold text-left w-6 rounded-sm flex flex-col justify-center items-center text-gray-600 dark:text-gray-300">
