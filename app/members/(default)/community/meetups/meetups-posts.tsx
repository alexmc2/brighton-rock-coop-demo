...
import MeetupsThumb01 from '@/public/members/images/meetups-thumb-01.jpg'
import MeetupsThumb02 from '@/public/members/images/meetups-thumb-02.jpg'
import MeetupsThumb03 from '@/public/members/images/meetups-thumb-03.jpg'
import MeetupsThumb04 from '@/public/members/images/meetups-thumb-04.jpg'
import MeetupsThumb05 from '@/public/members/images/meetups-thumb-05.jpg'
import MeetupsThumb06 from '@/public/members/images/meetups-thumb-06.jpg'
import MeetupsThumb07 from '@/public/members/images/meetups-thumb-07.jpg'
import MeetupsThumb08 from '@/public/members/images/meetups-thumb-08.jpg'
  ...
  return (
    <div className="grid xl:grid-cols-2 gap-6">
      ...
      <article className="flex bg-white dark:bg-gray-800 shadow-sm rounded-xl overflow-hidden">
        {/* Image */}
        <Link className="relative block w-24 sm:w-[14rem] xl:sidebar-expanded:w-40 2xl:sidebar-expanded:w-[14rem] shrink-0" href="/members/community/meetups/post">
          <Image
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            ...
            <Link className="inline-flex mb-2" href="/members/community/meetups/post">
