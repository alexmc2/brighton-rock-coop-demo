...
import GroupAvatar01 from '@/public/members/images/group-avatar-01.png';
import GroupAvatar02 from '@/public/members/images/group-avatar-02.png';
import GroupAvatar03 from '@/public/members/images/group-avatar-03.png';
import GroupAvatar04 from '@/public/members/images/group-avatar-04.png';
        ...
        <div className="md:py-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-xl">
              <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-4">
                Top Communities
              </div>
              ...
              <div className="mt-4">
                <button className="btn-sm w-full bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300">
                  View All
                </button>
              </div>
            </div>
