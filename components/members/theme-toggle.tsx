...
export default function ThemeToggle() {
  ...
  return (
    <div>
      ...
      />
      <label className="flex items-center justify-center cursor-pointer w-8 h-8 hover:bg-slate-100 lg:hover:bg-slate-200 dark:hover:bg-slate-700/50 dark:lg:hover:bg-slate-800 rounded-full" htmlFor="light-switch">
        <svg
          className="dark:hidden fill-current text-slate-500/80 dark:text-slate-400/80"
          width={16}
          height={16}
          viewBox="0 0 16 16"
        ...
        <svg
          className="hidden dark:block fill-current text-slate-500/80 dark:text-slate-300/80"
          width={16}
          height={16}
          viewBox="0 0 16 16"
          xmlns="http://www.w3.org/2000/svg"
